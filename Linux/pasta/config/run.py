...
from pasta.config.write_output import print_debug, StandardOutput
from pasta.config.constant import constant
from pasta.config.manage_modules import get_categories, get_modules
...
def run_pasta(category_selected='all', subcategories={}):
    """
    Main function
    """
    if not constant.st:
